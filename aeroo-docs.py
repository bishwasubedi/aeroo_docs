...
config_file = '/etc/aero-docs.conf'
conf = config['start']
...
top_parser.add_argument('-c', '--config-file', type=str,
...
top_parser.add_argument('-l', '--log-file', type=str,
...
if getattr(args, 'simple_auth', False):
    # Update simple auth credentials.
